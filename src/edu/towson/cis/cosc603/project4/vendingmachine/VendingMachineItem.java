...
public class VendingMachineItem {
	...
	private final static String NAME_MUST_BE_SPECIFIED_MESSAGE = "Name must not be null or empty string";
	...
	public VendingMachineItem( String name, double price ) throws VendingMachineException {
		if( name == null || name.isEmpty() ) {
			throw new VendingMachineException(NAME_MUST_BE_SPECIFIED_MESSAGE);
		}
		this.name = name;
		if( price < 0 ) {
